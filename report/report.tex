...
\begin{figure}[H]
  \vspace{-4.5em}
  \centering
  \subfloat[\texttt{NoEntry5.jpg} with detected bounding boxes]{\includegraphics[width = 0.24\textwidth]{images/task_3_6.jpg}}
  \hfill
  \subfloat[\texttt{NoEntry15.jpg} with detected bounding boxes]{\includegraphics[width = 0.24\textwidth]{images/task_3_4.jpg}}
  \hfill
  \subfloat[\texttt{NoEntry5.jpg} gradient magnitude threshold]{\includegraphics[width = 0.24\textwidth]{images/6_gradient_magnitude_threshold.jpg}}
  \hfill
  \subfloat[\texttt{NoEntry15.jpg} gradient magnitude threshold]{\includegraphics[width = 0.24\textwidth]{images/4_gradient_magnitude_threshold.jpg}}
  \hfill
  \subfloat[\texttt{NoEntry5.jpg} 2D Hough space]{\includegraphics[width = 0.24\textwidth]{images/6_hough_space.jpg}}
  \hfill
  \subfloat[\texttt{NoEntry15.jpg} 2D Hough space]{\includegraphics[width = 0.24\textwidth]{images/4_hough_space.jpg}}
