...
Since CIELAB is designed to be perceptually uniform, my algorithm then calculated the Euclidean distance from pure white and pure red to the two cluster centers, to identify whether the primary colours in the circle were red and white.
If the two primary colours where red and white, and there was more red in the circle than white, my algorithm then performs the line Hough transform on the circle.
