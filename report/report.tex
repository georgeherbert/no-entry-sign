...
In the Viola-Jones training process, the false positive rate (FPR) represents the proportion of images not containing the object being detected containing a predicted positive.
