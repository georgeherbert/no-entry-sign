...
In the Viola-Jones no entry sign training process, the false positive rate (FPR) represents the proportion of images not containing a no entry sign that the detector has predicted as containing a no entry sign.
